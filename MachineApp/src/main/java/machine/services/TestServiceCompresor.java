...
public class TestServiceCompresor {
	...
	public void insertMachine() {
		...
		screwCompressor.setMachineType(MachineType.COMPRESSOR);
		...
		pistonCompressor.setMachineType(MachineType.COMPRESSOR);
		...
		ad.setMachineType(MachineType.DRYER);
		...
		rf.setMachineType(MachineType.DRYER);
